...
func migrateSkinconcern(db *gorm.DB) error {
	...
	//concerns := []frontModel.Skinconcern{
	//	{ID: 1, Name: frontModel.ConcernRosacea},
	//	{ID: 2, Name: frontModel.ConcernHyperpigmentation},
	//	{ID: 3, Name: frontModel.ConcernMelasma},
	//	{ID: 4, Name: frontModel.ConcernCysticAcne},
	//	{ID: 5, Name: frontModel.ConcernAcne},
	//	{ID: 6, Name: frontModel.ConcernXerosis},
	//	{ID: 7, Name: frontModel.ConcernDryness},
	//	{ID: 8, Name: frontModel.ConcernOiliness},
	//	{ID: 9, Name: frontModel.ConcernUnevenSkinTone},
	//	{ID: 10, Name: frontModel.ConcernSignsOfAging},
	//	{ID: 11, Name: frontModel.ConcernFineLines},
	//	{ID: 12, Name: frontModel.ConcernWrinkles},
	//	{ID: 13, Name: frontModel.ConcernDarkSpots},
	//	{ID: 14, Name: frontModel.ConcernLostOfElasticityFirmness},
	//	{ID: 15, Name: frontModel.ConcernVisiblePores},
	//	{ID: 16, Name: frontModel.ConcernCloggedPoresBlackheads},
	//	{ID: 17, Name: frontModel.ConcernRedness},
	//	{ID: 18, Name: frontModel.ConcernDullness},
	//	{ID: 19, Name: frontModel.ConcernDamagedSkin},
	//	{ID: 20, Name: frontModel.ConcernUnevenTexture},
	//	{ID: 21, Name: frontModel.ConcernEczema},
	//	{ID: 22, Name: frontModel.ConcernPsoriasis},
	//	{ID: 23, Name: frontModel.ConcernDermatitis},
	//	{ID: 24, Name: frontModel.ConcernSunburnedSkin},
	//	{ID: 25, Name: frontModel.ConcernDarkCircles},
	//	{ID: 26, Name: frontModel.ConcernBlemishes},
	//	{ID: 27, Name: frontModel.ConcernSensitiveSkin},
	//	{ID: 28, Name: frontModel.ConcernNone},
	//}
